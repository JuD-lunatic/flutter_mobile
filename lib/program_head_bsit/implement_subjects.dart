    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          // Filter subjects to include only those with "Information Technology"
          _subjects = _subjects.where((subject) => subject.programs.contains('Information Technology')).toList();
          _isLoading = false;
        });
      } else {
